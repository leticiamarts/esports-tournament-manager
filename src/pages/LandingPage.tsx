...
const features = [
  {
    ...
    description:
      "Effortlessly manage tournament brackets with our automated system",
    icon: Trophy,
  },
  {
      ...
      <header className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 text-gray-300 max-w-3xl mx-auto">
            The most comprehensive platform for organizing and managing
      ...
      <section className="py-20 container mx-auto px-4">
        <div className="bg-gray-900 p-6 rounded-lg shadow-lg max-w-md mx-auto">
          ...
          <form onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              className="w-full bg-primary px-6 py-2 rounded text-white"
            >
              Login
            </button>
          </form>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400">
                Professional eSports tournament management platform for
